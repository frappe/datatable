...
export default class BodyRenderer {
    ...
    getNoDataHTML() {
        ...
        return `<div class="dt-scrollable__no-data" style='width: ${width-2}px; height: ${height}px'><div class='dt-scrollable__no-data no-data-message'>${this.options.noDataMessage}</div></div>`;
    }
